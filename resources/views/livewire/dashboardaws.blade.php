        ...
        <div class="flex flex-wrap -mx-4">
                ...
                <div class="weather-card mb-6 rounded-lg shadow-lg p-4 sm:p-6 bg-black text-white">
                    <div class="flex flex-wrap justify-center">
                        ...
                        <div class="w-full text-center mb-4">
                            <div class="text-lg sm:text-xl">{{ now()->translatedFormat('l, d F Y') }}</div>
                            <div class="text-base sm:text-lg">{{ now()->format('H:i') }}</div>
                        </div>
                            ...
                            <div class="flex flex-col items-center w-1/3 px-2">
                                <div class="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full border-8 border-yellow-400 flex items-center justify-center">
                                    <div class="text-center">
                                        ...
                                        <div class="text-2xl sm:text-3xl font-bold text-yellow-400 dark:text-yellow-300">{{ $weather_data['temperature']['min'] }}°</div>
                                        <div class="text-xs text-yellow-300 dark:text-yellow-200">Aktual: {{ $weather_data['temperature']['current'] }}°C</div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-col items-center w-1/3 px-2">
                                <div class="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full border-8 border-green-400 flex items-center justify-center">
                                    <div class="text-center">
                                        ...
                                        <div class="text-2xl sm:text-3xl font-bold text-green-400 dark:text-green-300">{{ $weather_data['temperature']['current'] }}°</div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-col items-center w-1/3 px-2">
                                <div class="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full border-8 border-blue-400 flex items-center justify-center">
                                    <div class="text-center">
                                        ...
                                        <div class="text-2xl sm:text-3xl font-bold text-blue-400 dark:text-blue-300">{{ $weather_data['wind']['speed'] }}km/h</div>
                                        <div class="text-xs text-blue-300 dark:text-blue-200">Arah: {{ $weather_data['wind']['direction'] }}°</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col items-center w-1/3 px-2">
                                <div class="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full border-8 border-purple-400 flex items-center justify-center overflow-hidden">
                                    ...
                                    <div class="text-center relative z-10">
                                        <div class="text-xs text-purple-300 dark:text-purple-200">Kelembaban<br><span>Dalam Ruangan</span></div>
                                        <div class="text-2xl sm:text-3xl font-bold text-purple-400 dark:text-purple-300">{{ $weather_data['temperature']['indoor'] }}%</div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-col items-center w-1/3 px-2">
                                <div class="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full border-8 border-orange-400 flex items-center justify-center">
                                    <div class="text-center">
                                        ...
                                        <div class="text-2xl sm:text-3xl font-bold text-orange-400 dark:text-orange-300">{{ $weather_data['rain']['rate'] }}</div>
                                        <div class="text-xs text-orange-300 dark:text-orange-200">mm/h</div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-col items-center w-1/3 px-2">
                                <div class="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full border-8 border-teal-400 flex items-center justify-center">
                                    <div class="text-center">
                                        ...
                                        <div class="text-2xl sm:text-3xl font-bold text-teal-400 dark:text-teal-300"> {{ $weather_data['temperature']['pressure'] }} </div>
                                        <div class="text-xs text-teal-300 dark:text-teal-200">mb</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="weather-card rounded-lg shadow-lg p-6 col-span-full mt-4">
                ...
                <div class="relative">
                    ...
                    <!-- Weather info overlay remains unchanged -->
                    <div class="absolute bottom-4 right-4 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg z-20">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center p-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors">
                                <div class="w-5 h-5 bg-blue-500/30 rounded-full mr-3 flex-shrink-0"></div>
                                <span class="text-sm">Suhu: {{ $weather_data['temperature']['current'] ?? 'N/A' }}°C</span>
                            </div>
                            <div class="flex items-center p-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors">
                                <div class="w-5 h-5 bg-red-500/30 rounded-full mr-3 flex-shrink-0"></div>
                                <span class="text-sm">Hujan: {{ $weather_data['rain']['rate'] ?? 'N/A' }} mm</span>
                            </div>
                            <div class="flex items-center p-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors">
                                <div class="w-5 h-5 bg-gray-500/30 rounded-full mr-3 flex-shrink-0"></div>
                                <span class="text-sm">Kelembaban Luar Ruangan: {{ $weather_data['temperature']['humidity'] ?? 'N/A' }}%</span>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 pt-4 border-t">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <span class="font-semibold text-base">Radiasi Matahari</span>
                            </div>
                            <div class="text-3xl font-bold mb-3 text-gray-800 dark:text-gray-200">
                                {{ $weather_data['solar']['radiation'] }} W/m²
                            </div>
                            <div class="flex justify-between items-center text-sm bg-gray-50 dark:bg-gray-700 p-2 rounded-lg">
                                <span class="text-gray-600 dark:text-gray-400">Rata rata {{ $selectedDate }}</span>
                                <span class="font-medium text-gray-800 dark:text-gray-200">{{ $weather_data['solar']['avg_today'] }} W/m²</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="w-full lg:w-1/4 px-4">
            <div class="space-y-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center gap-2 mb-2" id="weather-background">
                        <i class="fas fa-sun text-yellow-400"></i>
                        <span class="font-semibold">UV Index</span>
                    </div>
                    <div class="text-4xl font-bold mb-2">{{ $weather_data['uv']['value'] }} UVI</div>
                    <div class="inline-block bg-green-500 text-white text-xs px-3 py-1 rounded-full mb-2">
                        Low
                    </div>
                    <p class="text-sm text-gray-600 dark:text-gray-300">Risiko rendah dari sinar UV</p>
